...
console.log("  thing), brotli alone is hard to beat — it has access to the whole")
console.log("  byte sequence and can dedup identical fp32 patterns across snapshots.")
console.log()
...
console.log()
console.log("  Dense-update workloads (Adam steps touching every weight) leave")
console.log("  little room for either compressor; size parity is the realistic")
console.log("  expectation. Use weavepack here for partial-decode, not size.")
