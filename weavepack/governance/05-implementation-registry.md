...
| weavepack-tensor (Python, PoC) | Python 3.10+ | https://github.com/weavedb/arjson tree impl/python/ | tensor v0.1 partial (L1 decoder, schemaless + schemaful; no deltas) | 29/39 vectors | TBD |
