...
| weavepack-tensor (Python, PoC) | Python 3.10+ | https://github.com/weavedb/arjson tree impl/python/ | tensor v0.1 (L1 decoder, schemaless + schemaful + 4 delta ops) | 39/39 vectors | TBD |
